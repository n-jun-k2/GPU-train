...
train_set, valdation_set, test_set = load_pkl_gz(current_path + file)

x_train, y_train = mnist_to_pandas(train_set)
x_valdation, y_valdation = mnist_to_pandas(valdation_set)
x_test, y_test = mnist_to_pandas(test_set)
